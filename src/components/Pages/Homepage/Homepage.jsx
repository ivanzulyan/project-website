    ...
    <>
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center">
            ...
            <Link to="/login" className="mt-7 bg-blue-700 hover:bg-blue-400 text-white font-semibold py-1 px-4 rounded-xl md:py-3 md:px-6 md:text-lg lg:py-4 lg:px-8 lg:text-xl xl:py-4 xl:px-10 xl:text-2xl">Lihat Detail</Link>
